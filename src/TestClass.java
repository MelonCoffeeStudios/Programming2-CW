...
public class TestClass {
    public void runTest(){
        ...
        try {
            ...
            if(hands.hands.get(0).remove(3) != null) {
        ...
        try {
            if(hands.hands.get(0).remove(hands.hands.get(1))){
         ...
         */
        System.out.println("Size of Hand 2 (index 1): " + hands.hands.get(1).size());
